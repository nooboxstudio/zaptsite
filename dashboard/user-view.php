      ...
      <div class="container-fluid">
        <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title"><b>Atualizando usuário:</b> <i><?php echo $view['username']; ?></i></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <form action="users/user_update_query" method="post">
                <div class="form-row">
                  <div class="col-md-4">
                    <label for="">Nome de usuário:</label>
                    <input type="text" class="form-control" name="username" value="<?php echo $view['username']; ?>">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="password" value="<?php echo $view['password']; ?>">
                  </div>
                </div><br>
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <select name="level"  class="form-control">
                        <option value="<?php echo $view['level']; ?>" selected>
                        <?php if($view['level'] == 0){
